...
//boy1=createSprite(900,300,10,10);
...
function draw() {
 ...
 // Engine.update(engine)
  ...
  textSize(25);
  fill ("red");
  text("-Games4you",750 ,550);
  textSize(40);
  fill ("yellow");
  text("PLUCKING MANGOES",50 ,50);
  textSize(40);
  fill ("yellow");
  text("____________________",50 ,55);
 // textSize(20);
  //fill("black");
  ...
  boy.scale=3;
  //Engine.update(engine)
 // if (launcherObject.isTouching(mango1,mango2,mango3,mango4,mango5,mango6,mango7,
  //  mango8,mango9,mango10,mango11,mango12)) {
      //coingroup.destroyEach();
  // mangocollect = mangocollect + 1;
  // score = score + 20;
 //}
